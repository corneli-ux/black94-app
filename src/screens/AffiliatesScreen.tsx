...
const BADGE_CONFIG: Record<string, { color: string; bg: string; icon: string }> = {
  None: { color: colors.textSecondary, bg: colors.accentFaint, icon: 'ribbon-outline' },
  ...
  Platinum: { color: colors.textSecondary, bg: colors.accentBgStrong, icon: 'diamond-outline' },
};
