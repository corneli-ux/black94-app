...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#ffffff', fontWeight: '700', fontSize: 16, fontFamily: 'Inter-Bold' },
  preview: { paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 0.5, borderBottomColor: 'rgba(255,255,255,0.06)' },
  previewCaption: { color: '#94a3b8', fontSize: 14, lineHeight: 20, fontFamily: 'Inter-Regular' },
  list: { flex: 1, paddingHorizontal: 16 },
  emptyWrap: { alignItems: 'center', paddingVertical: 48 },
  emptyTitle: { color: '#e7e9ea', fontSize: 16, fontWeight: '700', marginTop: 12, fontFamily: 'Inter-Bold' },
  emptySub: { color: '#64748b', fontSize: 14, marginTop: 4, fontFamily: 'Inter-Regular' },
