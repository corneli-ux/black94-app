...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: '#0d0b14', borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: SHEET_HEIGHT, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  ...
  inputBar: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 16, paddingVertical: 10, borderTopWidth: 0.5, borderTopColor: 'rgba(255,255,255,0.08)', backgroundColor: '#0d0b14' },
